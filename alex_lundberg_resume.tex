...
\section{Experience}
  ...
  \resumeItemListStart
      ...
      \resumeItem{Kubernetes}
        {Managed Kubernetes cluster autoscaling and performed upgrades using Kops. Installed third-party tools using Helm. Used Traefik to control routing and firewalls.}
